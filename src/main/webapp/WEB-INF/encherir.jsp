...
<label for="meilleurEnchere">Meilleure offre : </label><p id="meilleurEnchere">${meilleureEnchere}</p>
...
<label for="montantEnchere">Ma proposition : </label><input type="number" id="montantEnchere" name="montantEnchere" value="${meilleureEnchere}">
