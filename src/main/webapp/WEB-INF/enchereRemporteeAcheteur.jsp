...
<label for="meilleurEnchere">Meilleure offre : </label>
	<p id="meilleurEnchere">${model.meilleureEnchere.montantEnchere} points par 
	<a href="http://localhost:8080/Encheres/UtilisateurDeconnecteServlet" title="Aller sur la page de ${model.meilleureEnchere.utilisateur.pseudo}">${model.meilleureEnchere.utilisateur.pseudo}</a></p>
...
<br>
<form action="EnchereRemporteeAcheteur" method="POST">
